...
const transporter = nodemailer.createTransport({
	...
	auth: {
		user: "kolaprabhas2310@gmail.com",
...
exports.sendMail = async function ({to, subject, text, html}) {
	...
	const info = await transporter.sendMail({
		from: '"SwiftStore" <kolaprabhas2310@gmail.com>', // sender address
...
exports.generateHtmlInvoice = function (order) {
...
<body style="background-color: #D2C7BA;">
    ...
    <div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
      We have received an order from your TrendCart account. This Email contains the details of your order.
    </div>
    <!-- end preheader -->
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; border-top: 3px solid #d4dadf;">
                            <h1 style="margin: 0; font-size: 20px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">Thank you for your order #${order.id}</h1>
                        </td>
                    </tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                            <p style="margin: 0;">Here is a summary of your recent order. If you have any questions or concerns about your order, please <a href="mailto:kolaprabhas2310@gmail.com">contact us</a>.</p>
                        </td>
                    </tr>
                    <!-- end copy -->
								...
								${order.items.map(item => {
									...
									`<tr>
										...
										<td
											...
											style="padding: 6px 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;"
										>
											${item.quantity}*${product.discountPrice.toFixed(2)}
										</td>
									</tr>`)
								}).join('</br>')}
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="center" bgcolor="#D2C7BA" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
                            <p style="margin: 0;">You received this email because we received a request for order for your account. If you didn't request an order please cancel the order and change your password to protect your account.</p>
                        </td>
                    </tr>
                    <!-- end permission -->
